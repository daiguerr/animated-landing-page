                ...
                <div className="message-cont">
                    <div className="left-items">
                        ...
                        <p className="m-para">
                            ...
                            Temporibus tempore amet consequuntur repellendus impedit suscipit,
                            veritatis debitis tempora rerum, aliquid saepe quae, voluptatibus
                            in error modi unde dolorem magni praesentium!
                        </p>
